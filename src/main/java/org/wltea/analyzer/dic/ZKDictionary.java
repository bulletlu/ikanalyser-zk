 ...
 *
 */
public class ZKDictionary implements Watcher{
	 ...
	 * 词典单子实例
	 */
	private static ZKDictionary singleton;
	...
	private ZKDictionary(Configuration cfg){
		this.cfg = cfg;
		this.initZk();
		this.loadMainDict();
	 ...
	 * @return Dictionary
	 */
	public static ZKDictionary initial(Configuration cfg){
		if(singleton == null){
			synchronized(ZKDictionary.class){
				if(singleton == null){
					singleton = new ZKDictionary(cfg);
					return singleton;
				}
			}
		}
	 ...
	 */
	public static ZKDictionary getSingleton(){
		if(singleton == null){
